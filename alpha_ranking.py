...
def run_alpha_ranking(
    ...
    pool_path = f'Documents/alphagen-master/checkpoints_{interval}/{file_duffix}/{pool_file_suffix}'
    alpha_path = f'Documents/alphagen-master/output_alpha/{interval}'
    return_path = f'Documents/alphagen-master/return/{interval}'
