...
def run_alpha_backtester(
    ...
    alpha_path = 'Documents/alphagen-master/output_alpha/'+interval  # Path where alphas are stored
    output_path = 'Documents/alphagen-master/output_result/'+interval  # Path to save the heatmap
    return_path = 'Documents/alphagen-master/return/'+interval+'/return.csv'
